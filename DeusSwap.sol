...
interface StaticPriceSale { // this is AutomaticMarketMaker! for coinbase
	...
	function calculatePurchaseReturn(uint256 deusAmount) external returns (uint256);
	function calculateSaleReturn(uint256 coinbaseTokenAmount) external returns (uint256);
}
